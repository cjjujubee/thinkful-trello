...
/***/ function(module, exports, __webpack_require__) {
	...
	var TrelloApp = React.createClass({
	    displayName: 'TrelloApp',
	
	    getInitialState: function getInitialState() {
	        return {
	            title: 'Knüth-Büth: Do What You Gotta Do',
	            lists: [{
	                id: '0',
	                title: 'Chores',
	                cards: ['Laundry', 'All the dishes', 'Wash the car'],
	                typed: ''
	            }, {
	                id: '1',
	                title: 'Groceries',
	                cards: ['Apples', 'Cookies', 'Booze'],
	                typed: ''
	            }]
	        };
	    },
	    ...
	    render: function render() {
	        return React.createElement(TrelloBoard, { board: this.state, onSubmit: this.onSubmit, onChange: this.onChange });
	    }
	});
	
	var TrelloBoard = function TrelloBoard(props) {
	    var trelloLists = [];
	    for (var i = 0; i < props.board.lists.length; i++) {
	        trelloLists.push(React.createElement(TrelloList, { key: i, list: props.board.lists[i], onSubmit: props.onSubmit, onChange: props.onChange }));
	    }
	...
	var TrelloList = function TrelloList(props) {
	    var cards = [];
	    for (var i = 0; i < props.list.cards.length; i += 1) {
	        cards.push(React.createElement(TrelloCard, { key: i, card: props.list.cards[i] }));
	    }
	    return React.createElement(
	        'div',
	        null,
	        ...
	        React.createElement(
	            'form',
	            { id: props.list.id, onSubmit: props.onSubmit },
	            React.createElement(Input, { onChange: props.onChange }),
	            React.createElement(Button, { text: 'Ready to be amazed?' })
	        )
	    );
	};
	
	var TrelloCard = function TrelloCard(props) {
	    return React.createElement(
	        'li',
	        { className: 'card' },
	        React.createElement(
	...
	var Input = function Input(props) {
	    return React.createElement('input', { type: 'text', onChange: props.onChange });
	};
	...
	document.addEventListener('DOMContentLoaded', function () {
	    ReactDOM.render(React.createElement(TrelloApp, null), document.getElementById('app'));
	});
...
/***/ }
/******/ ]);
//# sourceMappingURL=thinkful-trello.0.0.1.js.map